environment          = "stg"
organization         = "docsy"
service              = "docsy-meta-web"
log_retention_period = 7 ## days
cluster_id           = "stg-docsy-ecs-cluster-01"
desired_count        = 1
max_percent          = 300
min_healthy_percent  = 100
# tg_arn               = "arn:aws:elasticloadbalancing:ap-south-1:563901759783:targetgroup/stg-nivaan-weight-meta-web-tg/6b64c64855b1bbf2"
container_name     = "docsy-meta-web"
container_port     = 5000
...
tg_rule_priority        = 15
host_headers            = ["staging-meta.mydocsy.com"]
path                    = "/ping"
