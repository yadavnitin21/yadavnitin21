environment          = "stg"
organization         = "docsy"
service              = "docsy-meta-server"
log_retention_period = 7 ## days
cluster_id           = "stg-docsy-ecs-cluster-01"
desired_count        = 1
max_percent          = 300
min_healthy_percent  = 100
# tg_arn               = "arn:aws:elasticloadbalancing:ap-south-1:563901759783:targetgroup/stg-nivaan-weight-meta-server-tg/6b64c64855b1bbf2"
container_name     = "docsy-meta-server"
container_port     = 3000
...
tg_rule_priority        = 20
host_headers            = ["staging-meta-api.mydocsy.com"]
healthy_threshold       = 3
path                    = "/ping"
unhealthy_threshold     = 10
lb_arn_suffix           = "app/stg-docsy-ecs-alb-public/92bb61ea97bc5e14"
matcher                 = "200-399"